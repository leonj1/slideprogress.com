...
**Source of Truth**: `.claude/stopping_criteria.md`

**Core Heuristic**: A task is atomic when it can be verified by a unit test asserting a primitive (JSON, string, integer, boolean, array).

Use this heuristic to evaluate whether scenarios are at the right granularity.
